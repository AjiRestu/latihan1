...
$ git config --global user.email “nama_user”
 ![Gitconfig](https://github.com/AjiRestu/gambar2/blob/master/github%204.png)
...
- ![repolokal](https://github.com/AjiRestu/gambar2/blob/master/github%206.png)
...
- File README.md berhasil dibuat. 
- ![Filebaru](https://github.com/AjiRestu/gambar2/blob/master/github%207.png)

## Menambahkan File baru pada repository
- Untuk menambahkan file yang baru saja dibuat tersebut gunakan perintah git add.
- File README.md berhasil ditambahkan. 
- $ git add README.md
- ![Gitadd](https://github.com/AjiRestu/gambar2/blob/master/github%208.png)
...
- ![gitremoteaddorigin](https://github.com/AjiRestu/gambar-3/blob/master/github%2010.png)
## Push (Mengirim perubahan ke server)
- Untuk mengirim perubahan pada local repository ke server gunakan perintah git push.
- Perintah ini akan meminta memasukkan username dan password pada akun github.com
- $ git push -u origin master
- ![gitpushorigin](https://github.com/AjiRestu/gambar-3/blob/master/github%2011.png)
## Clone Repository
